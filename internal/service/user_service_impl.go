...
func NewUserService(userRepository repository.UserRepository, votingAccessRepository repository.VotingAccessRepository, envConfig *envConfig.Config, db *sql.DB, validate *validator.Validate) UserService {
